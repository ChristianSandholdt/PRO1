...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Customer c3 = new Customer("Timmy", LocalDate.of(2022,5,10));
       ...
       Discount ad = new AgeDiscount(10);
       ...
       c3.setDiscount(ad);
        ...
        System.out.println(c3.totalBuy());
        System.out.println(c3.totalBuyWithDiscount());
